...
void sepol_magisk_rules() {
	...
	sepol_attradd(SEPOL_PROC_DOMAIN, "coredomain"); //Samsung needed
	...
	sepol_allow(SEPOL_PROC_DOMAIN, "kernel", "system", ALL);	//Samsung needed
	...
	sepol_allow(SEPOL_PROC_DOMAIN, ALL, "tcp_socket", ALL); //Samsung needed
